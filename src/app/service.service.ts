...
export class Service {
  ...
  getAllBills() {
    ...
    // return this.http.get('https://order-track.herokuapp.com/bill/all');
  }
  ...
  saveBill(data: InventomryModel) {
    ...
    // return this.http.post('https://order-track.herokuapp.com/bill/add', data);
  }
  ...
  updateBill(data: InventomryModel) {
    ...
    // return this.http.put('https://order-track.herokuapp.com/bill/edit', data);
  }
  ...
  deleteBill(data) {
    ...
    // return this.http.put('https://order-track.herokuapp.com/bill/delete', data);
  }
}
